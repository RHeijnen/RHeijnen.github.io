...
$( document ).ready(function() {
    ...
    function loadSpriteSheets(){
        ...
        */ 
        ...
        var starfox = {
            images: ["/blog/2020/pixelportfolio/resources/protoanimation1/starfoxdiag-export.png"],
            ...
            posY : 144,
            framerate: 1,
            //hightlight : "/blog/2020/pixelportfolio/resources/protoanimation1/starfox.png",
            name : "tv"
        }; 

        // var hobbies = {
        //     images: ["/blog/2020/pixelportfolio/resources/protoanimation1/hobbies.png"],
        ...
        // };
        // var skills = {
        //     images: ["/blog/2020/pixelportfolio/resources/protoanimation1/skills.png"],
        ...
        // };
        var about = {
            images: ["/blog/2020/pixelportfolio/resources/protoanimation1/aboutbtn.png"],
        ...
        var pc = {
            images: ["/blog/2020/pixelportfolio/resources/protoanimation1/pc.png"],
    ...
    function setupMenuCovering(item){
        ...
        var buttonContainer = [
            {
                name: "skills",
                bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/skillsbtn.png",
                bitmapActive: "/blog/2020/pixelportfolio/resources/protoanimation1/skillsbtnactive.png",
                content: [
                    {
                        name: "skillscontent",
                        animated: false,
                        bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/skillscontent.png",
                        posX: 0,
                        posY: 0
                    },{
                        name: "skillsanim1",
                        ...
                        posY: 40,
                        animation: {
                            images: ["/blog/2020/pixelportfolio/resources/protoanimation1/skillsanim.png"],
            ...
            {
                name: "about",
                bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/aboutbtn.png",
                bitmapActive: "/blog/2020/pixelportfolio/resources/protoanimation1/aboutbtnactive.png",
                content: [
                    {
                        name: "aboutcontent",
                        animated: false,
                        bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/aboutcontent.png",
                        posX: 0,
                        posY: 0
                    },
                    {
                        name: "resumebtn",
                        animated: false,
                        bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/resumebtn.png",
                        posX: 236,
                        posY: 170,
                        onclick : "resume"
                    },
                    {
                        name: "linkedinBtn",
                        animated: false,
                        bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/linkedinbtn.png",
                        posX: 236,
                        posY: 220,
                        onclick : "linkedin"
            ...
            {
                name: "hobbies",
                bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/hobbies.png",
                bitmapActive: "/blog/2020/pixelportfolio/resources/protoanimation1/hobbiesactive.png",
                content: [
                    {
                        name: "hobbiescontent",
                        animated: false,
                        bitmap: "/blog/2020/pixelportfolio/resources/protoanimation1/hobbiescontent.png",
                        posX: 0,
                        posY: 0
                    }
                ],
        ...
        var menucover = new createjs.Bitmap("/blog/2020/pixelportfolio/resources/protoanimation1/menubase-export.png");
        menucover.name = "menucover"
        var closebtn = new createjs.Bitmap("/blog/2020/pixelportfolio/resources/protoanimation1/closebtn.png");
    ...
    function setupCanvas(){
        ...
        var background = new createjs.Bitmap("/blog/2020/pixelportfolio/resources/isocube.png");
        background.name = "background"
        stage.addChild(background);
        for(var i = 0; i < assetObjects.length;i++){
            var spriteSheet = new createjs.SpriteSheet(assetObjects[i]);
            var spriteObject = new createjs.Sprite(spriteSheet, "go");
            spriteObject.x = assetObjects[i].posX;
            spriteObject.y = assetObjects[i].posY;
            var name = assetObjects[i].name;
            spriteObject.name = name
            if(assetObjects[i].click){
                // stage.update();
                spriteObject.addEventListener("click", function(e) {
                    setupMenuCovering(e.target.name);
                });
