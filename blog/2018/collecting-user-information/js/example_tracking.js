...
document.addEventListener('DOMContentLoaded', function(){
    ...
    var getElementOnClick = function(event){
        ...
        if(elementContainer.length == 7){
            ElementString = ElementString + " ... "
        }else{
            ElementString = ElementString + checkpoint.className +" "

        }
        if(elementContainer.length > 7){
            return;
        }
        deleteCodeBlock("output8");
        writeCodeBlock("output8","Classes Clicked:\n >"+ ElementString)

    };


    document.addEventListener("click", getCoordOnClick);
    document.addEventListener("click", getElementOnClick);
    ...
    writeCodeBlock("output8","ElementContainer value:\n >"+ "click somewhere to activate")
